      ...
      <section class="container project-container mx-auto -mt-56">
        <div class="flex mt-3">
          <div class="w-3/4 mr-6">
            ...
            <div class="flex -mx-2">
              <div v-for="campaign in campaign.data.images" :key="campaign.image_url"
                ...
                <figure class="item-thumbnail">
                  <img
                    ...
                    @mouseover="changeImage($axios.defaults.baseURL + campaign.image_url)"
                  />
                </figure>
              </div>
            </div>
...
export default {
  ...
  methods: {
    ...
    async fund() {
      try {
        let response = await this.$axios.post('/api/transactions', this.transactions)
