<template>
    <div class="project-page">
      ...
      <section class="container mx-auto pt-8">
        ...
        <div class="block mb-2" v-if="campaigns.data != null">
            ...
            >
              <div class="mb-8">
                ...
                <p class="text-sm text-gray-600 flex items-center mb-2">
                  Rp. {{ new Intl.NumberFormat().format(campaign.current_amount) }} &middot; {{ (campaign.current_amount / campaign.goal_amount) * 100 }}%
                </p>
        ...
        <div class="block mt-2" v-else>
          <h3>Anda Belum Membuat Campaign</h3>
        </div>
...
export default {
  ...
  async asyncData({ $axios, app }) {
    const campaigns = await $axios.$get('/api/campaigns?user_id='+ app.$auth.user.id)
