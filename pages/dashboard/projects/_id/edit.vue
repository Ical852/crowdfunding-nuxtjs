                ...
                <div class="flex flex-wrap -mx-3 mb-6">
                  ...
                  <div class="w-full md:w-1/2 px-3">
                    ...
                    <input
                      ...
                      v-model.number="updateCampaign.goal_amount"
                    />
                  </div>
                  <div class="w-full px-3">
                    ...
                    <input
                      ...
                      v-model="updateCampaign.short_description"
                    />
                  </div>
                  <div class="w-full px-3">
                    <label
                  ...
                  <div class="w-full px-3">
                    ...
                    <textarea
                      ...
                      v-model="updateCampaign.description"
                    ></textarea>
                  </div>
                </div>
              </form>
...
export default {
  ...
  methods: {
    async save() {
    //   try {
    //     let response = await this.$axios.$put('/api/campaigns/' + this.$route.params.id, this.campaign)
    //     this.$router.push({ name: 'dashboard-projects-id', params : { id: response.data.id }})
